...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.addEventListener('scroll', () => {
        if (window.scrollY > 50) {
            navbar.style.boxShadow = '0 4px 20px rgba(107, 142, 247, 0.12)';
        } else {
            navbar.style.boxShadow = '0 2px 12px rgba(107, 142, 247, 0.08)';
        }
    });
    ...
    document.querySelectorAll('.info-card, .work-card, .tech-card, .module-card, .proposal-card, .team-card').forEach(el => {
        el.style.opacity = '0';
